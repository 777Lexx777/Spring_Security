package ru.springBoot.lex.springBoot.security;
...
import ru.springBoot.lex.springBoot.handler.SuccessUserHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(@SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
                                      UserDetailsService userDetailsService) {//@Qualifier("userDetailsServiceImpl")
